...
import com.uacam.pitbullmanagerapp.databinding.ActivityUpdatePasswordTeacherBinding
import java.util.regex.Pattern

class UpdatePasswordTeacherActivity : AppCompatActivity() {

    private lateinit var binding: ActivityUpdatePasswordTeacherBinding
    private lateinit var auth: FirebaseAuth
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding =ActivityUpdatePasswordTeacherBinding.inflate(layoutInflater)
