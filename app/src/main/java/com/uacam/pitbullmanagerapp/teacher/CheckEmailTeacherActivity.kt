...
import com.uacam.pitbullmanagerapp.databinding.ActivityCheckEmailTeacherBinding

class CheckEmailTeacherActivity : AppCompatActivity() {
    private lateinit var auth: FirebaseAuth
    private lateinit var binding: ActivityCheckEmailTeacherBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityCheckEmailTeacherBinding.inflate(layoutInflater)
