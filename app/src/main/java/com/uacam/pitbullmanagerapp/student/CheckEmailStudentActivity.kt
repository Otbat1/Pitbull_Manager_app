...
import com.uacam.pitbullmanagerapp.databinding.ActivityCheckEmailStudentBinding

class CheckEmailStudentActivity : AppCompatActivity() {
    private lateinit var auth: FirebaseAuth
    private lateinit var binding: ActivityCheckEmailStudentBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityCheckEmailStudentBinding.inflate(layoutInflater)
