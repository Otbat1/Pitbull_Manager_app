...
import com.uacam.pitbullmanagerapp.MainActivity
import com.uacam.pitbullmanagerapp.databinding.ActivityUpdatePasswordStudentBinding
import java.util.regex.Pattern

class UpdatePasswordStudentActivity : AppCompatActivity() {
    private lateinit var binding: ActivityUpdatePasswordStudentBinding
    private lateinit var auth: FirebaseAuth
    
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityUpdatePasswordStudentBinding.inflate(layoutInflater)
